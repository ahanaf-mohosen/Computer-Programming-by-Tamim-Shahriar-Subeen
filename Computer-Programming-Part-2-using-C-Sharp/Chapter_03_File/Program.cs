...
//            // Calculate average
//            double average = (mathMark + banglaMark + englishMark) / 3.0;

//            // Write to the average file
//            averageWriter.WriteLine($"{roll} {average:F2}");
//        }
//    }
//    Console.WriteLine("Averages have been written to the output file.");
//}
//catch (Exception ex)
//{
//    Console.WriteLine($"Error: {ex.Message}");
